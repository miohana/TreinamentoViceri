...
GO
PRINT N'Creating [dbo].[FK_Mensagem_Usuario]...';


GO
ALTER TABLE [dbo].[Mensagem]
    ADD CONSTRAINT [FK_Mensagem_Usuario] FOREIGN KEY ([IdUsuario]) REFERENCES [dbo].[Usuario] ([Id]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '643afb24-322e-4d5d-9493-b09000182eb1')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('643afb24-322e-4d5d-9493-b09000182eb1')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'deca42f1-e6e5-48d7-901b-883160b70c9a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('deca42f1-e6e5-48d7-901b-883160b70c9a')
